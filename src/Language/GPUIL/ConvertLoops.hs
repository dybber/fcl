...
warpSize = UnaryOpE WarpSize (IntE 0)
...
convertLoops :: [Stmt NoType] -> [Stmt NoType]
convertLoops = concatMap convertLoop

convertLoop :: Stmt NoType -> [Stmt NoType]
convertLoop stmt =
  case stmt of
...
compileForAll :: Stmt NoType -> [Stmt NoType]
